          ...
          <form action="{{route("item.store")}}" method="POST" enctype="multipart/form-data">
            ...
            <section class="form-section">
              ...
              <div class="form-group">
                <label for="item-category-tag" class="form-label"
                  >カテゴリー</label
                >
                 {{-- エラーメッセージ --}}
...
@foreach($categories as $category)
<label><input type="checkbox" name="categories[]" value="{{$category->id}}" @if (in_array($category->id,old("categories", []))) checked @endif>{{$category->category_name}}</label>
@endforeach
                </div>
...
<option value="{{$condition->id}}" @if (old("condition") == $condition->id) selected @endif>{{$condition->condition_name}}</option>
@endforeach
                </select>
              </div>
            </section>
            ...
            <section class="form-section">
              ...
              <div class="form-group">
                ...
                <textarea
                  ...
                  class="item-description__textarea"
                  placeholder=""
