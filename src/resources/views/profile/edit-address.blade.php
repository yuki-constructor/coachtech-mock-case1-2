    ...
    <main>
      <div class="container-wrap">
        <div class="container">
          ...
          <form class="form" action="{{route('profile.update.address',["itemId"=>$item->id])}}" method="POST">
            @csrf
...
value="{{ $errors->any() ? old('postal_code') : $user->postal_code }}"
            ...
            <div class="form-group">
              ...
              <input
                ...
                id="address"
                name="address"
                {{-- value="@if($errors->has("postal_code")||$errors->has("address")||$errors->has("building")){{old("address")}}@else{{$user->address}}@endif" --}}
            ...
            <div class="form-group">
              ...
              <input
                ...
                id="building"
                name="building"
                {{-- value="@if($errors->has("postal_code")||$errors->has("address")||$errors->has("building")){{old("building")}}@else{{$user->building}}@endif" --}}
