...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/profile/create.css')); ?>" />
</head>
    ...
    <main>
        <div class="container-wrap">
            <div class="container">
                ...
                <form class="form" action="<?php echo e(route('profile.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/resources/views/profile/create.blade.php ENDPATH**/ ?>