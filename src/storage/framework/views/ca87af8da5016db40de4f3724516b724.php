...
<head>
    ...
    <title>プロフィール</title>
    <link rel="stylesheet" href="<?php echo e(asset('css/profile/show-buy.css')); ?>" />
</head>
...
<body>
    ...
    <main>
        ...
        <div class="menu">
            <a href="<?php echo e(route('profile.show.sell')); ?>" class="menu__left-link">出品した商品</a>
            ...
            <?php $__currentLoopData = $purchases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="item">
                    <img class="item-image"
                        src="<?php echo e(asset('storage/photos/item_images/' . $purchase->item->item_image)); ?>" alt="">
                    <div class="item-name"><?php echo e($purchase->item->item_name); ?></div>
                </div>
...
<?php /**PATH /var/www/resources/views/profile/show-buy.blade.php ENDPATH**/ ?>