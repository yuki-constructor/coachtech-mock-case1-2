    ...
    <main>
        <div class="container-wrap">
            <div class="container">
                ...
                <form class="form" action="<?php echo e(route('profile.edit')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="profile-image__container">
                            <div class="profile-image-placeholder">
                                <img class="profile-image"
                                    src="<?php echo e(asset('storage/photos/profile_images/' . $user->profile_image)); ?>"
                                    alt="">
                            </div>
                            <label>画像を選択する
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-group__input" type="text" id="name" name="name"
                            value="<?php echo e($errors->any() ? old('name') : $user->name); ?>" />
                    </div>
                    <div class="form-group">
