...
<head>
    ...
    <title>購入確認</title>
    <link rel="stylesheet" href="<?php echo e(asset('css/items/purchase.css')); ?>">
</head>
    ...
    <main class="purchase-confirmation">
        <section class="item-info">
            <div class="item-image">
                <img class="image-placeholder" src="<?php echo e(asset('storage/photos/item_images/' . $item->item_image)); ?>"
                    alt="">
            </div>
            <div class="item-details">
                <h1 class="item-name"><?php echo e($item->item_name); ?></h1>
                <p class="item-price">¥<?php echo e(number_format($item->price)); ?></p>
            </div>
        </section>

        <section class="order-details">
            <form action="<?php echo e(route('item.purchase.payment', ['itemId' => $item->id])); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <h2>支払い方法</h2>
                <div class="payment">
                ...
                <div class="address">
                    <div class="address-address">
                        <h2>配送先</h2>
                        <p>〒 <?php echo e($user->postal_code); ?></p>
                        <p> <?php echo e($user->address); ?></p>
                        <p> <?php echo e($user->building); ?></p>
                    </div>
                    <div class="address-edit">
                        <a href="<?php echo e(route('profile.edit.address', ['itemId' => $item->id])); ?>"
        ...
        <section class="total-details">
            <div class="total-item border-next">
                <span>商品代金</span>
                <span class="total-details-content">¥ <?php echo e(number_format($item->price)); ?></span>
            </div>
            <div class="total-item border-next">
                <span>支払い方法</span>
...
<?php /**PATH /var/www/resources/views/items/purchase.blade.php ENDPATH**/ ?>